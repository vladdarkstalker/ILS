# Generated by Django 5.1.6 on 2025-03-23 07:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_retakes', models.BooleanField(default=False, verbose_name='Разрешить повторное прохождение')),
            ],
            options={
                'verbose_name': 'Тест',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a', models.FloatField(default=1.0, verbose_name='Параметр дискриминации (a)')),
                ('b', models.FloatField(default=0.0, verbose_name='Параметр сложности (b)')),
                ('c', models.FloatField(default=0.0, verbose_name='Параметр угадывания (c)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_taken', models.DateTimeField(auto_now_add=True)),
                ('theta', models.FloatField(default=0.0, verbose_name='Оценка способности θ')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_results', to='learnsys.test')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_index', models.PositiveIntegerField(default=0, verbose_name='Порядок отображения')),
                ('generated_text', models.TextField(blank=True, null=True, verbose_name='Сгенерированный текст')),
        ...
        migrations.AddField(
            model_name='testitem',
            name='source_content',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='learnsys.topiccontent'),
        ),
        migrations.CreateModel(
            name='UserTestAnswer',
            fields=[
                ...
                ('option', models.ManyToManyField(blank=True, to='learnsys.testitemoption')),
        ...
        migrations.CreateModel(
            name='AdaptiveTestSession',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('theta', models.FloatField(default=0.0, verbose_name='Оценка способности')),
                ...
                ('current_complexity', models.CharField(choices=[('easy', 'Легкий'), ('medium', 'Средний'), ('hard', 'Сложный')], default='medium', max_length=10, verbose_name='Текущая сложность')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='learnsys.test', verbose_name='Тест')),
                ('asked_items', models.ManyToManyField(blank=True, to='learnsys.testitem', verbose_name='Заданные вопросы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allowed', models.BooleanField(default=False, verbose_name='Разрешено повторное прохождение')),
                ('granted_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата разрешения')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='testretakepermission', to='learnsys.test', verbose_name='Тест')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_tests', models.PositiveIntegerField(default=0, verbose_name='Количество пройденных тестов')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progresses', to='learnsys.topic', verbose_name='Тема')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_progresses', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
