    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ManyToManyField(blank=True, to='learnsys.testitemoption', verbose_name='Выбранные варианты')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('granted_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата разрешения')),
